...
var consoleQuestNotifyStyles = [
	"color: #01abdf; font-size: 16px; font-weight: 600; background-color: #000000;margin: 10px 10px 10px 15px;padding: 5px 5px 5px 15px;border-left: 2px solid #01abdf;line-height: 24px",
